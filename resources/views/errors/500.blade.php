    ...
    <div class="max-w-lg w-full bg-white rounded-3xl shadow-2xl overflow-hidden relative transform transition-all hover:scale-[1.01] duration-300">
        ...
        <div class="p-8 sm:p-12 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="{{ route('dashboard') }}" class="group px-6 py-3 bg-gray-900 text-white font-bold rounded-xl hover:bg-gray-700 transition-colors shadow-lg shadow-gray-200 uppercase text-[10px] tracking-widest flex items-center justify-center gap-2">
                    Back to Safety
