...
<body class="antialiased overflow-x-hidden pt-20 md:pt-24 bg-iba-light text-iba-black dark:bg-iba-black dark:text-iba-light transition-colors duration-300">
    ...
    <footer class="bg-iba-light dark:bg-iba-black pt-16 transition-colors duration-300 border-t-8 border-iba-red relative z-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            {{-- HEAVY DIVIDER --}}
            <div class="border-t-4 border-dashed border-iba-black/20 dark:border-iba-light/20 w-full mb-16"></div>
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                ...
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center gap-4 mb-6">
                        <div class="w-12 h-12 bg-iba-red border-4 border-iba-black dark:border-iba-light text-white flex items-center justify-center shadow-[4px_4px_0_0_#131011] dark:shadow-[4px_4px_0_0_#FFFBF7]">
                    ...
                    <div class="flex space-x-4">
                        {{-- Facebook --}}
                        <a href="https://www.facebook.com/BUMadya" class="w-12 h-12 bg-white dark:bg-[#1A1617] border-4 border-iba-black dark:border-iba-light flex items-center justify-center hover:-translate-y-1 hover:bg-iba-teal hover:text-white transition-all shadow-[4px_4px_0_0_#131011] dark:shadow-[4px_4px_0_0_#FFFBF7] text-iba-black dark:text-iba-light">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>

                        {{-- Instagram --}}
                        <a href="https://www.instagram.com/bu_madya" class="w-12 h-12 bg-white dark:bg-[#1A1617] border-4 border-iba-black dark:border-iba-light flex items-center justify-center hover:-translate-y-1 hover:bg-iba-red hover:text-white transition-all shadow-[4px_4px_0_0_#131011] dark:shadow-[4px_4px_0_0_#FFFBF7] text-iba-black dark:text-iba-light">
                        ...
                        {{-- X (Twitter) --}}
                        <a href="https://www.x.com/bu_madya" class="w-12 h-12 bg-white dark:bg-[#1A1617] border-4 border-iba-black dark:border-iba-light flex items-center justify-center hover:-translate-y-1 hover:bg-iba-black hover:text-white dark:hover:bg-iba-light dark:hover:text-iba-black transition-all shadow-[4px_4px_0_0_#131011] dark:shadow-[4px_4px_0_0_#FFFBF7] text-iba-black dark:text-iba-light">
                ...
                <div class="flex flex-col justify-center">
                    <ul class="space-y-4 text-iba-black dark:text-iba-light font-bold text-sm">
                        ...
                        <li class="pt-4 mt-2 border-t-4 border-dashed border-iba-black/20 dark:border-iba-light/20">
                            <a href="{{ route('privacy') ?? '#' }}" class="text-xs text-gray-500 hover:text-iba-red hover:translate-x-1 transition-transform inline-block">Privacy Policy</a>
                        </li>
                    </ul>
                </div>
                ...
                {{-- Col 4: Live Stats --}}
                <div class="flex flex-col justify-center">
                    <h4 class="font-pixel text-[10px] sm:text-xs mb-4 text-iba-green tracking-widest uppercase">Live System Stats</h4>
                    <div class="bg-iba-black dark:bg-[#1A1617] p-6 border-4 border-iba-black dark:border-iba-light shadow-[6px_6px_0_0_#0095AC] dark:shadow-[6px_6px_0_0_#0095AC]">
                        <span class="block font-bold text-[10px] uppercase tracking-widest text-iba-light/50 mb-2">Total Terminals Accessed</span>
                        <div class="text-3xl sm:text-4xl font-pixel text-iba-orange tracking-widest">
