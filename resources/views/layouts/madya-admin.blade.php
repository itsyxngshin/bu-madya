...
<body class="bg-stone-50 font-sans antialiased text-gray-900">
    ...
    <div x-data="{ sidebarOpen: true }" class="flex h-screen overflow-hidden bg-stone-50">
        ...
        {{-- 2. SIDEBAR COMPONENT --}}
        {{-- We pass the Alpine state down to it via attributes or context --}}
        ...
        <div class="flex-1 flex flex-col overflow-hidden relative">
            ...
            {{-- TOP HEADER --}}
            <header class="h-16 bg-white/90 backdrop-blur-md border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 z-30 sticky top-0">
                
                {{-- Left: Toggle & Title --}}
                <div class="flex items-center gap-4">
                    <button @click="sidebarOpen = true" class="text-gray-500 focus:outline-none lg:hidden hover:text-red-600 transition">
