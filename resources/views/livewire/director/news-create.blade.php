<div class="bg-gray-100 font-sans text-gray-900 h-[calc(100vh-120px)]" 
    ...
    {{-- 1. NAVIGATION BAR --}}
    <nav class="shrink-0 z-30 bg-white/90 backdrop-blur-md border-b border-gray-200 h-16 px-6 flex items-center justify-between rounded-t-2xl">
        ...
        <div class="h-full overflow-y-auto bg-stone-100 relative shadow-inner transition-all duration-300 ease-in-out"
            ...
            <div class="fixed top-24 right-8 z-50 flex gap-2">
                <button @click="previewFullScreen = !previewFullScreen; editorFullScreen = false" 
                        class="bg-white/80 backdrop-blur text-gray-600 hover:text-red-600 p-2 rounded-full shadow-md border border-gray-200 transition-all hover:scale-110" 
