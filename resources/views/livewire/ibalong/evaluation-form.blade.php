    ...
    @else
        ...
        <div class="bg-white border-4 border-iba-black shadow-[8px_8px_0_0_#FF8623] p-6 relative">
            ...
            <div class="flex items-center justify-between mt-2 mb-2">
                <h1 class="text-2xl font-black text-iba-black uppercase tracking-wider">{{ $evaluation->title }}</h1>
                @if($totalPages > 1)
                    <span class="bg-gray-100 border-2 border-iba-black text-iba-black text-[10px] font-black uppercase px-3 py-1">
