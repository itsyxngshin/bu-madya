    ...
    <div class="bg-white border-4 border-iba-black shadow-[8px_8px_0_0_#131011] overflow-x-auto">
        <table class="min-w-full divide-y-4 divide-iba-black">
            <thead class="bg-gray-100">
                <tr>
                    <th class="px-6 py-4 text-center text-xs font-black uppercase tracking-widest text-iba-black">Rank</th>
                ...
                @forelse($leaderboard as $index => $row)
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            @if($row['total_judges'] > 0)
                                <div class="flex flex-wrap gap-2">
                                    @foreach($row['judge_totals'] as $judgeName => $total)
                                        <div class="border border-iba-black bg-gray-50 p-2 flex flex-col min-w-[120px]">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            @else
                                <span class="text-xs font-black text-iba-red uppercase">Pending</span>
                            @endif
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-center border-t-4 border-dashed border-gray-300 bg-gray-50">
                            <p class="text-sm font-black text-gray-500 uppercase tracking-widest">No cohorts have been evaluated yet.</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
