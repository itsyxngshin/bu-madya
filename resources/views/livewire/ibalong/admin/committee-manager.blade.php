                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end items-center gap-3">
                                        ...
                                        {{-- NEW: Approve & Email Button (Only shows if inactive and has an email) --}}
                                        @if(!$member->is_active && $member->email)
                                            <button wire:click="approveAndNotify({{ $member->id }})" wire:loading.attr="disabled" class="text-teal-600 dark:text-teal-400 font-bold hover:underline flex items-center gap-1">
