                    ...
                    @if($isAdminView)
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex gap-2">
                                <a href="{{ route('ibalong.admin.evaluations.results', $eval->slug) }}" class="flex-1 bg-iba-teal text-white text-center text-[10px] font-black uppercase tracking-widest py-2 border-2 border-iba-black hover:bg-teal-700 transition-colors">View Data</a>
