    ...
    <div class="relative min-h-screen px-6 pb-24 mt-12 max-w-[1800px] w-[95%] mx-auto">
        ...
        <div class="relative z-10 mb-12 animate-fade-in-up">
            <div class="group relative rounded-3xl overflow-hidden shadow-2xl h-[400px] md:h-[500px]">
                {{-- Image --}}
                <img src="{{ $featured->cover_img ? asset('storage/'.$featured->cover_img) : 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=2070' }}" 
                ...
                <div class="absolute bottom-0 left-0 p-8 md:p-12 w-full md:w-2/3">
                    <div class="flex items-center gap-3 mb-3">
                        <span class="px-3 py-1 bg-yellow-400 text-green-900 text-[10px] font-black uppercase tracking-wider rounded-md">
                            Top Story
                        </span>
                        {{-- Vote Counter Badge --}}
                    ...
                    <a href="{{ route('news.show', $featured->slug) }}" class="inline-flex items-center gap-2 text-white font-bold hover:text-yellow-400 transition">
        ...
        <div class="relative z-10 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article class="group bg-white/60 backdrop-blur-md border border-white/60 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-2 transition duration-300 flex flex-col">
                ...
                <div class="h-48 overflow-hidden relative">
                    <img src="{{ $article->cover_img ? asset('storage/'.$article->cover_img) : 'https://source.unsplash.com/random/400x300?sig='.$article->id }}" 
            ...
            <div class="col-span-3 py-10 flex flex-col items-center justify-center text-gray-500 opacity-70">
                ...
                <p>No stories found matching "{{ $search }}".</p>
            </div>
            @endforelse
        </div>
