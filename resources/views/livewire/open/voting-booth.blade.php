    ...
    @else
        ...
        <div class="bg-white rounded-[2.5rem] shadow-lg border border-gray-200 overflow-hidden mb-8 relative">
            ...
            <div class="px-6 md:px-10 pb-8 relative z-10 -mt-12 md:-mt-16 text-center md:text-left flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    {{-- THE FIX: Election Description Added Here --}}
                    ...
                    <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-orange-50 border border-orange-100 rounded-lg shadow-sm">
                        ...
                        <p class="text-[11px] font-bold text-orange-700 uppercase tracking-wider">Please review your selections carefully before casting.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-10">
            @foreach($positions as $position)
                ...
                <div class="bg-white rounded-[2rem] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-200 relative overflow-hidden flex flex-col" wire:key="pos-{{ $position->id }}">
                    
                    {{-- Security Ribbon & Position Header --}}
                            ...
                            @foreach($position->candidates as $candidate)
                                ...
                                <div wire:click="toggleSelection({{ $position->id }}, {{ $candidate->id }})" 
                                    ...
                                    <div class="absolute top-5 right-5 w-8 h-5 rounded-full border-[3px] flex items-center justify-center transition-all duration-300 shadow-inner
                                        ...
                                        @if($isSelected)
                                            <svg class="w-3 h-3 text-white animate-fade-in" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="4"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg>
                                        @endif
                                    </div>
        ...
        <div class="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6 bg-gradient-to-t from-white via-white/80 to-transparent pointer-events-none">
