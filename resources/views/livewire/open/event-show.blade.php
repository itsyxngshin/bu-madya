<div class="min-h-screen bg-stone-50 font-sans text-gray-900 relative overflow-x-hidden">
    ...
    {{-- ==========================================
         1. BACKGROUND BLOBS (Fixed & Low Z-Index)
       ========================================== --}}
    ...
    {{-- ==========================================
         2. MAIN CONTENT WRAPPER (Elevated Z-Index)
       ========================================== --}}
    <div class="relative z-10">
        ...
        <header class="relative pt-32 pb-16 px-6 max-w-7xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="order-2 lg:order-1">
                    ...
                    <h1 class="font-heading text-4xl md:text-6xl font-black text-gray-900 leading-[1.1] mb-6 drop-shadow-sm">
                        {{ $event->title }}
                    </h1>
                    ...
                    <div class="flex flex-wrap gap-6 text-stone-600 mb-8">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-white border border-gray-100 shadow-sm text-red-600 flex items-center justify-center">
                        ...
                        <div class="hidden md:block pl-6 border-l border-gray-300">
                ...
                <div class="order-1 lg:order-2 relative group">
                    ...
                    <div class="absolute inset-0 bg-yellow-400/80 rounded-[2.5rem] rotate-3 opacity-20 group-hover:rotate-6 transition duration-500 blur-sm"></div>
        ...
        <div class="max-w-7xl mx-auto px-6 pb-24 grid lg:grid-cols-12 gap-12">
            ...
            <aside class="lg:col-span-4 space-y-8 order-2 lg:order-1">
                ...
                {{-- Event Details Card --}}
                <div class="bg-white/80 backdrop-blur-md p-6 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden">
                    ...
                    <ul class="space-y-5 relative z-10">
                        ...
                        <li class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                @if($event->end_date)
                                    <span class="block text-[10px] font-bold text-gray-400 uppercase mt-2">End</span>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100">
                        ...
                        <p class="text-center text-[10px] text-gray-400 mt-2 font-medium">Opens in a new tab</p>
                    </div>
                    @endif
                </div>
                ...
                {{-- QR Card --}}
                @if($event->isOpen() && $event->registration_link)
                <div class="bg-white/80 backdrop-blur-md p-6 rounded-3xl shadow-sm border border-gray-100 text-center">
                    <h3 class="font-bold text-gray-400 uppercase tracking-widest text-[10px] mb-4">Scan to Register</h3>
                    <div class="flex justify-center mb-4">
                        <div id="share-qr" class="p-2 bg-white rounded-xl shadow-inner border border-gray-100 w-[140px] h-[140px] flex items-center justify-center"></div>
                    </div>
                    <div class="flex justify-center gap-2">
                        <button onclick="navigator.clipboard.writeText('{{ $event->registration_link }}'); alert('Link copied to clipboard!');" class="text-xs font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-lg hover:bg-blue-100 transition">
                            Copy Link
                        </button>
                    </div>
                </div>
            ...
            <main class="lg:col-span-8 space-y-12 order-1 lg:order-2">
                {{-- Content with backdrop for readability over blobs --}}
                <div class="bg-white/60 backdrop-blur-sm p-8 rounded-[2rem] border border-white/50 shadow-sm">
                    <div class="prose prose-lg prose-stone max-w-none 
                        ...
                        prose-img:rounded-3xl prose-img:shadow-xl prose-img:border prose-img:border-gray-100 prose-img:w-full prose-img:object-cover">
    ...
    @if($event->isOpen() && $event->registration_link)
    <div class="fixed bottom-0 left-0 right-0 p-4 bg-white/90 backdrop-blur-xl border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] md:hidden z-50">
