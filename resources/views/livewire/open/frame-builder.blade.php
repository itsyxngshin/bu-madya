<div class="min-h-screen bg-gray-50/50 py-8 px-4 sm:px-6 lg:px-8 font-sans pb-24">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            {{-- LEFT COLUMN: Details (Strict 1/3 width) --}}
            <div class="w-full lg:w-1/3 shrink-0 space-y-6 lg:sticky lg:top-24">
                <div>
                    ...
                    <div class="flex items-center gap-3 bg-white p-3 rounded-2xl border border-gray-100 shadow-sm inline-flex">
            ...
            <div class="w-full lg:flex-1 min-w-0">
                <div class="bg-white p-5 md:p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 ring-1 ring-gray-900/5"
                     @php
                         // Safe array mapping: check if frame_images is valid
                ...
                >
                    ...
                    <div x-show="frames.length > 1" style="display: none;" class="mt-8 bg-gray-50/50 p-4 rounded-2xl border border-gray-100 max-w-lg mx-auto">
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('studio', (frameUrls) => ({
            ...
            init() {
                ...
                // Set the initial active frame safely
            ...
            loadFrameImage(url) {
                ...
                this.frameImg.crossOrigin = "Anonymous"; // Prevent canvas tainting
                ...
                this.frameImg.onerror = () => {
                    ...
                    this.imageError = true;
                    this.frameImg = null; // Prevent broken drawing
                    this.draw(); 
                };

                this.frameImg.src = url; // Set src AFTER onload/onerror definitions
            },
