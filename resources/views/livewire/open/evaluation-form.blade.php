<div class="min-h-screen bg-gray-50 pb-20 font-sans text-gray-900">
    ...
    @if(!$evaluation->is_active)
        <div class="max-w-xl mx-auto px-4 pt-20 text-center">
            <div class="bg-white rounded-[2rem] p-10 shadow-xl border border-gray-200">
                ...
                <p class="text-gray-500 mb-8">This evaluation form is no longer accepting responses.</p>
                <a href="{{ route('open.home') }}" class="inline-block px-8 py-3 bg-gray-900 text-white font-bold rounded-xl shadow-lg hover:bg-gray-800 transition text-sm uppercase tracking-widest">
                    Return Home
                </a>
            </div>
        </div>
