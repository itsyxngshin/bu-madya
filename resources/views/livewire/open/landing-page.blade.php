        ...
        <div class="max-w-[1800px] w-[95%] mx-auto px-6 grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="flex space-x-4">
                    ...
                    {{-- Instagram --}}
                    <a href="www.instagram.com/bu_madya" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-pink-600 hover:text-white text-gray-400 transition">
                    ...
                    {{-- X (Twitter) --}}
                    <a href="www.x.com/bu_madya" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-black hover:text-white text-gray-400 transition">
