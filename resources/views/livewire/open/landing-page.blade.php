        ...
        <div class="grid lg:grid-cols-12 gap-8 items-start">
            ...
            <aside class="lg:col-span-4 space-y-8 lg:sticky lg:top-24">
                ...
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 class="font-heading font-bold text-gray-900 leading-tight">Project Calendar</h3>
                        <p class="text-xs text-gray-500 uppercase tracking-wide font-bold">Upcoming Activities</p>
                    </div>
                </div>
