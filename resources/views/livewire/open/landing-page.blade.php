                ...
                >
                    ...
                    <div class="bg-yellow-400 rounded-3xl p-6 text-green-900 shadow-lg relative overflow-hidden">
                        ...
                        <p class="text-sm opacity-80 mb-4">We are open for collaborations.</p>
                         <a href="{{ route('proposals.create') }}" class="block w-full py-2 bg-gradient-to-r from-red-600 to-yellow-500 text-white text-xs font-bold uppercase rounded-lg shadow hover:shadow-lg transition transform hover:-translate-y-0.5">
                            Propose Project
                        </a>
                    </div>
                </div>
