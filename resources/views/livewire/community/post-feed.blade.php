    ...
    <div class="space-y-6">
        @forelse($posts as $post)
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                {{-- 4. Engagement Stats Summary --}}
                <div class="px-4 py-2 flex items-center justify-between text-xs font-bold text-gray-500 border-b border-gray-100 mx-2">
                    <div class="flex items-center gap-1">
                        <span class="text-sm">🔥</span>
                        <span>{{ $post->elements_count }} Elements</span>
                    </div>
                ...
                <div class="px-2 py-1 flex items-center justify-between">
                    <a href="{{ route('community.posts.show', $post->slug) }}" class="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg hover:bg-gray-50 text-gray-600 font-bold text-sm transition-colors cursor-pointer">
