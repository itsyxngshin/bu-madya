    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-white rounded-[2rem] p-6 shadow-sm border border-gray-200">
                    ...
                    <div class="mb-4">
                        ...
                        {{-- UPDATED: wire:model.live="title" --}}
                        <input wire:model.live="title" type="text" class="w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:border-orange-500 focus:ring-orange-500 text-sm font-bold transition" placeholder="e.g., Project Post-Mortem">
                    ...
                    <div class="mb-4">
                        ...
                        {{-- UPDATED: wire:model="project_id" --}}
                        <select wire:model="project_id" class="w-full rounded-xl border-gray-200 bg-gray-50 focus:border-orange-500 text-sm font-bold">
                    ...
                    <div class="mb-4">
                        ...
                        {{-- UPDATED: wire:model="description" --}}
                        <textarea wire:model="description" rows="4" class="w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:border-orange-500 focus:ring-orange-500 text-sm transition resize-none" placeholder="Instructions for the user..."></textarea>
                    </div>
                ...
                <div class="bg-red-50 rounded-[2rem] p-6 border border-red-100">
                    ...
                    <button onclick="confirm('Are you sure? This cannot be undone.') || event.stopImmediatePropagation()" wire:click="delete" class="w-full py-2 bg-white border border-red-200 text-red-600 font-bold rounded-xl hover:bg-red-600 hover:text-white transition text-xs uppercase tracking-wide">
                        Delete Form
                    </button>
                </div>
                @endif
            ...
            <div class="lg:col-span-8">
                ...
                {{-- Questions Toolbar --}}
                <div class="bg-gray-900 text-white p-4 rounded-t-[2rem] flex flex-wrap justify-between items-center shadow-md gap-2">
                    <span class="font-bold ml-2">Form Content</span>
                    <div class="flex gap-2">
                        ...
                        {{-- Separator Button --}}
                        <button wire:click="addQuestion('section')" class="px-3 py-1.5 bg-white/10 hover:bg-white/20 rounded-lg text-xs font-bold transition flex items-center gap-1 border-l border-white/20 ml-2">
                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg> Separator
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-b-[2rem] p-6 shadow-sm border border-t-0 border-gray-200 min-h-[400px] space-y-4" wire:sortable="updateQuestionOrder">
                    ...
                    @foreach($questions as $index => $question)
                        ...
                        @if($question['type'] === 'section')
                            <div wire:sortable.item="{{ $index }}" wire:key="question-{{ $index }}" class="group relative bg-orange-50 border-2 border-dashed border-orange-200 rounded-xl p-4 my-6 hover:border-orange-300 transition-colors">
                                <div class="absolute left-0 top-0 bottom-0 w-8 flex items-center justify-center cursor-move text-orange-300 hover:text-orange-500 rounded-l-xl" wire:sortable.handle>
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8h16M4 16h16"></path></svg>
                                </div>
                                <div class="pl-8 flex items-center gap-4">
                                    <div class="flex-1">
                                        <label class="text-[10px] font-bold text-orange-400 uppercase tracking-widest mb-1">Section Header</label>
                                        <input type="text" wire:model="questions.{{ $index }}.question_text" 
                                               class="w-full text-xl font-black text-gray-800 border-0 bg-transparent placeholder-orange-300 focus:ring-0 p-0" 
                                               placeholder="Type Section Title (e.g., Part II)">
                                    </div>
                                    <button wire:click="removeQuestion({{ $index }})" class="text-orange-300 hover:text-red-500 transition">
                        ...
                        @else
                            <div wire:sortable.item="{{ $index }}" wire:key="question-{{ $index }}" class="group relative bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:border-orange-200">
                                ...
                                <div class="absolute left-0 top-0 bottom-0 w-8 flex items-center justify-center cursor-move text-gray-300 hover:text-gray-500 hover:bg-gray-50 rounded-l-2xl" wire:sortable.handle title="Drag to reorder">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8h16M4 16h16"></path></svg>
                                </div>
