...
<head>
    <style>
        body { font-family: Arial, sans-serif; background-color: #f9fafb; padding: 20px; color: #131011; }
        .container { max-w-width: 600px; margin: 0 auto; background-color: #ffffff; border: 4px solid #131011; box-shadow: 6px 6px 0px 0px #0095AC; padding: 30px; }
        h1 { text-transform: uppercase; border-bottom: 4px solid #FF8623; padding-bottom: 10px; font-weight: 900; }
        .highlight { background-color: #0095AC; color: #ffffff; padding: 5px 10px; font-weight: bold; text-transform: uppercase; }
        .footer { margin-top: 30px; padding-top: 20px; border-top: 2px dashed #131011; font-size: 12px; font-weight: bold; text-transform: uppercase; color: #6b7280; }
    </style>
</head>
<body>
