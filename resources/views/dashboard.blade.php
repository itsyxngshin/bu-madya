<div> {{-- 1. THIS IS THE REQUIRED SINGLE ROOT ELEMENT --}}

    {{-- HEADER SLOT --}}
    {{-- Livewire will hoist this up to the layout automatically --}}
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-heading font-black text-2xl text-gray-800 leading-tight">
    ...
    {{-- MAIN CONTENT --}}
    <div class="py-12 bg-stone-50 min-h-screen font-sans">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            
            {{-- 1. WELCOME BANNER --}}
            <div class="relative bg-gray-900 rounded-[2.5rem] p-8 overflow-hidden shadow-xl flex items-center justify-between text-white">
                ...
                <div class="relative z-10">
                    <h1 class="text-3xl font-black font-heading mb-2">Welcome back, {{ Auth::user()->name }}!</h1>
                ...
                <div class="relative z-10 hidden md:flex items-center gap-3">
                    ...
                    {{-- 1. Create News (Secondary Action) --}}
                    <a href="{{ route('news.create') }}" 
                       class="px-5 py-3 bg-white/10 border border-white/20 text-white text-xs font-bold uppercase rounded-xl hover:bg-white/20 transition flex items-center gap-2 backdrop-blur-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>
                        <span>Add News</span>
                    </a>

                    {{-- 2. Create Project (Primary Action) --}}
                    <a href="{{ route('projects.create') }}" 
                       class="px-6 py-3 bg-white text-gray-900 text-xs font-black uppercase rounded-xl shadow-lg hover:scale-105 transition flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {{-- Card 1: Pending --}}
                <a href="{{ route('admin.proposals.index') }}" class="group bg-white p-6 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition relative overflow-hidden">
                    ...
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <span class="text-[10px] font-bold uppercase text-gray-400 bg-gray-50 px-2 py-1 rounded">Action Needed</span>
                    </div>
                    <h3 class="text-3xl font-black text-gray-900 mb-1">{{ $pendingProposals }}</h3>
                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wide">Pending Proposals</p>
                </a>
                ...
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden">
                    ...
                    <h3 class="text-3xl font-black text-gray-900 mb-1">{{ $activeProjects }}</h3>
                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wide">Ongoing Projects</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden">
                    ...
                    <h3 class="text-3xl font-black text-gray-900 mb-1">{{ $totalPartners }}</h3>
                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wide">Linkages</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden">
                    ...
                    <h3 class="text-3xl font-black text-gray-900 mb-1">{{ $totalUsers }}</h3>
                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wide">Registered Users</p>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 bg-white rounded-[2rem] shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl hover:bg-gray-100 transition group">
                            <div class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center font-bold text-xs text-gray-500">
                            ...
                            <a href="{{ route('admin.proposals.show', $proposal->id) }}" class="px-3 py-1 bg-white border border-gray-200 text-gray-600 text-[10px] font-bold uppercase rounded-lg shadow-sm hover:border-red-300 hover:text-red-600 transition">
                                Review
                            </a>
                        </div>
                        @empty
                ...
                <div class="bg-gray-900 text-white rounded-[2rem] shadow-lg p-6 relative overflow-hidden">
                    ...
                    <div class="space-y-4 relative z-10">
                        ...
                        <div class="p-4 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/5">
            ...
            <div>
                <h3 class="font-heading font-black text-xl text-gray-800 mb-6 flex items-center gap-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    @empty
                    <div class="col-span-2 bg-white rounded-3xl p-8 text-center border border-dashed border-gray-300">
