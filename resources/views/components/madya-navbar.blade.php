            ...
            <div class="flex items-center gap-4">
                ...
                <div class="hidden md:flex items-center gap-3">
                    ...
                    @auth
                        ...
                        <div class="relative ml-2" x-data="{ dropdownOpen: false }">
                            ...
                            <div x-show="dropdownOpen"
                                 ...
                                 class="absolute right-0 mt-2 w-48 rounded-xl shadow-xl py-1 bg-white border border-gray-100 ring-1 ring-black ring-opacity-5 focus:outline-none z-50"
                                 style="display: none;">
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="px-4 py-2 bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-red-600 hover:text-white hover:shadow-lg transition transform hover:-translate-y-0.5 whitespace-nowrap">Join Us</a>
                    @endauth
                </div>
        ...
        <div class="px-4 pb-6 pt-2 bg-gray-50/50 border-t border-gray-100">
            ...
            @else
                <div class="grid grid-cols-2 gap-3">
                     <a href="{{ route('login') }}" class="flex justify-center items-center py-2.5 bg-white border border-gray-200 rounded-lg text-xs font-bold uppercase tracking-wide text-gray-700 hover:bg-gray-50 transition">
                         Log In
                     </a>
                     <a href="{{ route('register') }}" class="flex justify-center items-center py-2.5 bg-gray-900 text-white rounded-lg text-xs font-bold uppercase tracking-wide hover:bg-red-600 hover:text-white transition shadow-lg">
                         Join Us
                     </a>
                </div>
            @endauth
